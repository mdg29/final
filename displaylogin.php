...
<div class=" login">
    ...
    <h1> <center>Log in IS218</center></h1>
    <form action="email.php" method = "post">
        <i class="fa fa-user icon"></i>

        <center><label>Email: <input class="input-field" type="text" placeholder="Email" name="email" required/></label>

            <center><label>Password:<input  class="input-field" type="Password" placeholder="Password" name="Password" required/></label></center>
            <input type="submit" value="Submit">
            <p><a href="https://web.njit.edu/~mdg29/IS218/hw1/reg.html">New Users</a></p>
            ...
            <div id="openModal" class="modalDialog">
                <div>
                    ...
                    <p>
                        ...
                        Welcome to https://web.njit.edu/~mdg29/IS218/hw1/1.php
                        These terms and conditions outline the rules and regulations for the use of https://web.njit.edu/~mdg29/IS218/hw1/1.php's Website.
                        https://web.njit.edu/~mdg29/IS218/hw1/1.php is located at:
                        Address: 323 Dr Martin Luther King Jr Blvd, Newark, NJ 07102 , NewarkNew Jersey - 07102, United States

                        By accessing this website we assume you accept these terms and conditions in full. Do not continue to use https://web.njit.edu/~mdg29/IS218/hw1/1.php's website
                        ...
                        We employ the use of cookies. By using https://web.njit.edu/~mdg29/IS218/hw1/1.php's website you consent to the use of cookies
                        in accordance with https://web.njit.edu/~mdg29/IS218/hw1/1.php’s privacy policy.Most of the modern day interactive web sites
                        use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
                        to enable the functionality of this area and ease of use for those people visiting. Some of our
                        affiliate / advertising partners may also use cookies.License
                        Unless otherwise stated, https://web.njit.edu/~mdg29/IS218/hw1/1.php and/or it’s licensors own the intellectual property rights for
                        all material on https://web.njit.edu/~mdg29/IS218/hw1/1.php. All intellectual property rights are reserved. You may view and/or print
                        pages from https://web.njit.edu/~mdg29/IS218/hw1/1.php#close for your own personal use subject to restrictions set in these terms and conditions.
                        You must not:

                        Republish material from https://web.njit.edu/~mdg29/IS218/hw1/1.php#close
                        Sell, rent or sub-license material from https://web.njit.edu/~mdg29/IS218/hw1/1.php#close
                        Reproduce, duplicate or copy material from https://web.njit.edu/~mdg29/IS218/hw1/1.php#close

                        Redistribute content from https://web.njit.edu/~mdg29/IS218/hw1/1.php (unless content is specifically made for redistribution).
                        ...
                        you must notify us by sending an e-mail to mdg29@njit.edu.
                        ...
                        No use of https://web.njit.edu/~mdg29/IS218/hw1/1.php’s logo or other artwork will be allowed for linking absent a trademark license
                        agreement.
                        Iframes
            ...
            <a href="https://www.facebook.com/mike.grinaway" class="fa fa-facebook"></a>
            <a href="https://twitter.com/?lang=en" class="fa fa-twitter"></a>
            <a href="https://www.instagram.com/visualsby_daniel/?hl=en" class="fa fa-instagram"></a>
            <center>
